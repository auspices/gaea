...
import { ContentEntityAttachmentFragment } from '../../../generated/types/ContentEntityAttachmentFragment'
...
export const ContentEntityAttachment: React.FC<ContentEntityAttachmentProps> =
  ({ attachment, ...rest }) => {
    return (
      <Box
        as="a"
