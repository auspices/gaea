...
export type CollectionContentEntityFragment =
  | CollectionContentEntityFragment_Text
  | CollectionContentEntityFragment_Image
  | CollectionContentEntityFragment_Link
